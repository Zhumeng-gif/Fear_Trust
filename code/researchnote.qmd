...
## outputs
msummary(list(glm_newData,did_matNewr,lm_newDatain,did_matNewz,glm_newData_max,glm_newData_maxin,did_matNewm),
         output="../outputs/regression2.docx",
         stars = TRUE)
```
...
library("boot")
set.seed(1206)
newData_on$treat <- as.numeric(newData_on$treat)
boot_out <- boot(newData_on, boot_fun, R = 1000)

boot_out
boot.ci(boot_out,type = "perc")
plot(boot_out,index = 9)
```
