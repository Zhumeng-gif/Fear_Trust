...
#mat_pku2009n <- matchit(as.factor(treat) ~ age + female + edu + marriage + hukouRural,data = df_pku2009n,replace = TRUE,ratio = 3)
...
```{r cem_NewData}
cem_cbs2002n <- matchit(as.factor(treat) ~ age + female + edu + marriage + hukouRural,method = "cem",data = df_cbs2002n)
...
cem_cbs2014n <- matchit(as.factor(treat) ~ age + female + edu + marriage + hukouRural,method = "cem",data = df_cbs2014n)
df_cem_cbs2014n <- match.data(cem_cbs2014n)

cem_cbs2019n <- matchit(as.factor(treat) ~ age + female + edu + marriage + hukouRural,method = "cem",data = df_cbs2019n)
df_cem_cbs2019n <- match.data(cem_cbs2019n)

cem_cgss2010n <- matchit(as.factor(treat) ~ age + female + edu + marriage + hukouRural,method = "cem",data = df_cgss2010n)
...
cem_css2006n <- matchit(as.factor(treat) ~ age + female + edu + marriage + hukouRural,method = "cem",data = df_css2006n)
...
cem_css2019n <- matchit(as.factor(treat) ~ age + female + edu + marriage + hukouRural,method = "cem",data = df_css2019n)
df_cem_css2019n <- match.data(cem_css2019n)

cem_css2021n <- matchit(as.factor(treat) ~ age + female + edu + marriage + hukouRural,method = "cem",data = df_css2021n)
